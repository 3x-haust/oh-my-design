...
Spawn `oh-my-design:scout` with the concept, surface classification, component inventory, user
...
Spawn a fresh `oh-my-design:composer` with only the sanitized frame/concept (including the surface
