...
quality reason, not just a prestigious gallery name. Siteinspire pages are discovery wrappers: retain
the observed original website, not the wrapper chrome. Use `omd schema reference-research --json`,
