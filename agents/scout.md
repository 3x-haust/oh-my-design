...
keep at least one target-market source in each lane with a source-specific reason that explains how
it serves the named market/task/audience plus the retained image's exact SHA-256, and attach a concrete gap to every global
