...
Render exactly four structural proofs into your candidate directory:
1. fixed desktop, 1280x900;
2. fixed mobile, 390x844;
3. full-page desktop continuity, 1280x900 with `--full-page`;
4. full-page mobile continuity, 390x844 with `--full-page`.
