...
const REFERENCE_RESEARCH: InputSkeleton = {
  ...
  constraints: [
    ...
    'new v6 domainReference.sources contains at least three independently inspected comparable services from three distinct service families; multiple GOV.UK pages/subdomains or any other single operator count as one family. Historical v5 remains readable but cannot be relabelled as new research.',
    ...
    'when ref discover-plan v2 returns marketReferencePolicy.mode=target-market-first, execute its exact domainSearchInputs and market-qualified design inputs before unqualified global searches. Both lanes require target-market coverage, remain operator-independent, and may fall back to global equivalents only after a documented target-market gap. A local URL is not a quality score or a country-style instruction.',
